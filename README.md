...
## Classpip-server
Este es el repositorio del código de la aplicación (en su versión en desarrollo) que realiza tareas de notificación entre usuarios y también tareas de registro de actividad.
...
## Puesta en marcha
Pon en marcha la aplicación con el comando siguiente: 
```
npm start
```
El servidor empezará a escuchar en: localhost:8080
